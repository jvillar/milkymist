...
@echo addDevice -position 1 -file .\parallel_flash_memory_uart_programmer.bit  >> impact_batch_commands.cmd
@echo addDevice -position 2 -part "xcf04s"                                     >> impact_batch_commands.cmd
@echo addDevice -position 3 -part "xc2c64a"                                    >> impact_batch_commands.cmd
