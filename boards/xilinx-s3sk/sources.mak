...
SDRAM_SRC=$(wildcard $(CORES_DIR)/sdram-yadmc/rtl/*.v)
UART_SRC=$(wildcard $(CORES_DIR)/uart/rtl/*.v)
SYSCTL_SRC=$(wildcard $(CORES_DIR)/sysctl/rtl/*.v)
PS2_SRC=$(wildcard $(CORES_DIR)/ps2/rtl/*.v)
ETHERNET_SRC=$(wildcard $(CORES_DIR)/ethernet/rtl-lite/*.v)

CORES_SRC=$(CONBUS_SRC) $(LM32_SRC) $(CSRBRG_SRC) $(NORFLASH_SRC) $(BRAM_SRC) $(SDRAM_SRC) $(UART_SRC) $(SYSCTL_SRC) $(PS2_SRC) $(ETHERNET_SRC)
